...
import giftsImage from "@/assets/categories/gifts-category.jpg";
import teasImage from "@/assets/categories/teas-category.jpg";
import samplersImage from "@/assets/categories/samplers-category.jpg";
